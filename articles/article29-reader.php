<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article29.json";
    
    // FIXED: Set to exactly match your education page index definition for line 29
    $fallbackTitle = "Amazing: 2 Wars Ended In One Day"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 29
    $pageKeywords = "Amazing 2 Wars Ended, End of Conflict, Peace Transition, Economic Dividends, Geopolitics, Financial Shift";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article29">
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Peace 700x555.jpg' class="norm-image"><br>
    <p class='par' id='tx_05'></p>
    <p class='par' id='tx_06'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Riot Police 700x467.jpg' class="norm-image">
    ...
    <img src='<?php echo $baseHref; ?>img/Photo CBDC 700x263.jpg' class="norm-image">
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article29.json');
