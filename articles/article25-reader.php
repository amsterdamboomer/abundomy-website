<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article25.json";
    
    // FIXED: Set to exactly match your education page index definition for line 25
    $fallbackTitle = "Prepare For Financial Harakiri"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 25
    $pageKeywords = "Prepare For Financial Harakiri, Financial Collapse, Economic Suicide, Systemic Meltdown, Capital Devaluation";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article25">
    ...
    <!-- ========================================= -->
    <img src='<?php echo $baseHref; ?>img/Photo Harakiri 700x448.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 448; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    ...
    <blockquote class="blockquote blockquote--bordered">
      ...
      <p class="blockquote__text blockquote__text--credit" id='tx_11'></p>
    </blockquote>
    ...
    <ol>
        ...
        <li><p class='par' id='tx_23'></p></li>
        <li><p class='par' id='tx_24'></p></li>
        <li><p class='par' id='tx_25'></p></li>
        <li><p class='par' id='tx_26'></p></li>
        <li><p class='par' id='tx_27'></p></li>
    </ol>
    <p class='par' id='tx_28'></p>
    <p class='par' id='tx_29'></p>
    <p class='par' id='tx_30'></p>
    <p class='par' id='tx_31'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Greenback 700x622.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 622; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    <p class='par_italic' id='tx_32' style='text-align: center; width: 100%; display: block;'></p>
    <p class='par' id='tx_33'></p>
    <p class='par' id='tx_34'></p>
    <p class='par' id='tx_35'></p>
    <p class='par' id='tx_36'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Tower Of Babel 700x439.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 439; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    <p class='par_italic' id='tx_37' style='text-align: center; width: 100%; display: block;'></p>
    <span class='title3' id='tx_38'></span>
    <ul>
      <li><a href='https://www.abundomy.com/articles/article08-reader.php' class='link' id='tx_39'></a></li>
      <li><a href='https://silviogesell.com/' class='link' id='tx_40'></a></li>
    </ul>    <blockquote class="blockquote blockquote--bordered">
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article25.json');
