<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article06.json";
    
    // FIXED: Set to exactly match your education page index definition for line 6
    $fallbackTitle = "Free Local Economies"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 06
    $pageKeywords = "Free Local Economies, Community Wealth, Alternative Trade, Decentralized Markets, Regional Finance";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article06">
    ...
    <!-- ========================================= -->
    <img src='<?php echo $baseHref; ?>img/Photo Fish Market 700x700.jpg' class="norm-image"><br>
    <p class='par_italic' id='tx_04'></p>
   ...
   <img src='<?php echo $baseHref; ?>img/Photo House Sold 700x700.jpg' class="norm-image"><br>
    <span class='title3' id='tx_13'></span>
    <p class='par' id='tx_14'></p>
    <span class='par_bold' id='tx_15'></span>
    <p class='par' id='tx_16'></p>
    <span class='par_bold' id='tx_17'></span>
    <p class='par' id='tx_18'></p>
   <img src='<?php echo $baseHref; ?>img/Photo Carrot And Stick 700x524.jpg' class="norm-image"><br>
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Ghana Independence 700x273.jpg' class="norm-image"><br>
    <p class='par' id='tx_28'></p>
    <p class='par' id='tx_29'></p>
    <p class='par' id='tx_30'></p>
    <p class='par' id='tx_31'></p>
   <img src='<?php echo $baseHref; ?>img/Photo TrumpTrojan Horse 700x700.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 700; height: auto !important; display: block; margin: auto; object-fit: contain;' /><br>
    <span class='title3' id='tx_32'></span>
    <p class='par' id='tx_33'></p>
    <p class='par' id='tx_34'></p>
    <p class='par' id='tx_35'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Asterix 700x564.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 564; height: auto !important; display: block; margin: auto; object-fit: contain;' /><br>
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Food 700x700.jpg' class="norm-image"><br>
    <p class='par' id='tx_43'></p>
    <span class='par_bold' id='tx_44'></span>
    <p class='par' id='tx_45'></p>
    <p class='par' id='tx_46'></p>
    <span class='par_bold' id='tx_47'></span>
    <p class='par' id='tx_48'></p>
    <p class='par' id='tx_49'></p>
    <p class='par' id='tx_50'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Frodo 700x454.jpg' class='norm-image'><br>
    <p class='par' id='tx_51'></p>
    <p class='par' id='tx_52'></p>
    <p class='par' id='tx_53'></p>
    <span class='title3' id='tx_54'></span>
    <ul>
      <li><a href='https://www.tweedekamer.nl/kamerstukken/wetsvoorstellen/detail?id=2020Z22508&dossier=35646' class='link' target='_blank' id='tx_55'></a></li>
      <li><a href='https://www.washingtonpost.com/politics/2024/09/24/trump-keeps-talking-about-criminalizing-dissent/' class='link' target='_blank' id='tx_56'></a></li>
      <li><a href='https://www.usccb.org/resources/what-does-church-say-about-debt-and-jubilee' class='link' target='_blank' id='tx_57'></a></li>
    </ul>
    <blockquote class="blockquote blockquote--bordered">
      <p class="blockquote__text" id='tx_58'></p>
      <p class="blockquote__text" id='tx_59'></p>
      <p class="blockquote__text" id='tx_60'></p>
    </blockquote>
    <!-- ========================================= -->
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article06.json');
