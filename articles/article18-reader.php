<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article18.json";
    
    // FIXED: Set to exactly match your education page index definition for line 18
    $fallbackTitle = "How to Leave the System"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 18
    $pageKeywords = "Leave the System, Financial Autonomy, Economic Exit, Opt Out, Financial Sovereignty, Alternative Network";
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article18">
...
<p class='par' id='tx_04'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Allo Allo 700x394.jpg' class="norm-image">
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Rogan Trump 700x378.jpg' class="norm-image"><br>
    ...
    <p class='par_italic' id='tx_18' style='text-align: center; width: 100%; display: block;'></p>
    <p class='par' id='tx19'></p>
    <p class='par' id='tx_20'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Blckbx 700x368.jpg' class="norm-image"><br>
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Michelle Dubois 467x700.jpg' style='width: clamp(234px, 81.08vw, 467px); aspect-ratio: 467 / 700; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    <p class='par_italic' id='tx_30' style='text-align: center; width: 100%; display: block;'></p>
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article18.json');
