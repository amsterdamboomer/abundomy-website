<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article16.json";
    
    // FIXED: Set to exactly match your education page index definition for line 16
    $fallbackTitle = "Don't Try To Stop This Crude Carrier!"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 16
    $pageKeywords = "Crude Carrier, Inevitable Transition, Momentum of Reform, Economic Momentum, System Shift, Abundomy Development";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article16">
    ...
    <!-- ========================================= -->
    <img src='<?php echo $baseHref; ?>img/Photo Crude Tanker 700x469.jpg' class="norm-image"><br>
    <p class='par' id='tx_04'></p>
    <p class='par' id='tx_05'></p>
    <p class='par' id='tx_06'></p>
    <p class='par' id='tx_07'></p>
    <p class='par' id='tx_08'></p>
    <img src='<?php echo $baseHref; ?>img/Photo 1984 470x700.jpg' style='width: clamp(235px, 81.60vw, 470px); aspect-ratio: 470 / 700; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    <p class='par_italic' id='tx_09' style='text-align: center; width: 100%; display: block;'></p>
    ...
    <ul>
      <li><a href='https://youtu.be/zSff0pwc1Xc?si=z5VMUEjfSiFwfXs3' class='link' target='_blank' id='tx_18'></a></li>
      <li><a href='https://en.wikipedia.org/wiki/Nineteen_Eighty-Four' class='link' target='_blank' id='tx_19'></a></li>
      <li><a href='https://www.abundomy.com' class='link' target='_blank' id='tx_20'></a></li>
      <li><a href='https://www.1coinh.com' class='link' target='_blank' id='tx_21'></a></li>
    </ul>
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article16.json');
