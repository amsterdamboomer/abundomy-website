<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article08.json";
    
    // FIXED: Set to exactly match your education page index definition for line 8
    $fallbackTitle = "What is wrong with cryptocurrencies?"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 08
    $pageKeywords = "Cryptocurrency Flaws, Bitcoin Flaws, Crypto Issues, Speculative Assets, Digital Money Deficiencies";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article08">
    ...
    <blockquote class="blockquote blockquote--bordered">
      ...
      <p class="blockquote__text blockquote__text--credit" id='tx_06'></p>
    </blockquote>
    <img src='<?php echo $baseHref; ?>img/Photo Michel Foucault.jpg' style='width: 402px; height: 270px; display: block; margin: auto;' /><br>
    <p class='par' id='tx_07'></p>
    <p class='par' id='tx_08'></p>
    <blockquote class="blockquote blockquote--bordered">
      <p class="blockquote__text" id='tx_09'></p>
      <p class="blockquote__text blockquote__text--credit" id='tx_10'></p>
    </blockquote>
    ...
    <blockquote class="blockquote blockquote--bordered">
      ...
      <p class="blockquote__text blockquote__text--credit" id='tx_19'></p>
    </blockquote>
    <img src='<?php echo $baseHref; ?>img/Photo Mayer Amschel Rothschild.jpg' style='width: 278px; height: 400px; display: block; margin: auto;' />
    <span class='par_italic' id='tx_20' style='text-align: center; width: 100%; display: block;'></span>
    <span class='par_italic' id='tx_21' style='text-align: center; width: 100%; display: block;'></span>
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article08.json');
