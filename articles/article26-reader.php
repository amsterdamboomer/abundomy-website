<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article26.json";
    
    // FIXED: Set to exactly match your education page index definition for line 26
    $fallbackTitle = "Talking In Nations"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 26
    $pageKeywords = "Talking In Nations, Nationalism, Sovereign Boundaries, Geopolitics, Global Borders, Nation States";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article26">
    ...
    <!-- ========================================= -->
    <img src='<?php echo $baseHref; ?>img/Photo Ghana Independence Square 700x525.jpg' class="norm-image">
    <p class='par_italic' id='tx_04' style='text-align: center; width: 100%; display: block;'></p>
    <p class='par' id='tx_05'></p>
    <span class='title3' id='tx_06'></span>
    ...
    <blockquote class="blockquote blockquote--bordered">
      ...
      <p class="blockquote__text" id='tx_19'></p>
    </blockquote>
    <!-- ========================================= -->
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article26.json');
