<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article09.json";
    
    // FIXED: Set to exactly match your education page index definition for line 9
    $fallbackTitle = "The Banking Exodus"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 09
    $pageKeywords = "Banking Exodus, Leaving the Banks, Financial Collapse, Alternative Economy, Bank Runs, Capital Flight";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article09">
    ...
    <img src='<?php echo $baseHref; ?>img/Photo They Live 700x318.jpg' class="norm-image">
    <span class='title3' id='tx_12'></span>
    <p class='par' id='tx_13'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Zelenski 700x420.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 420; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    <p class='par' id='tx_14'></p>
    <p class='par' id='tx_15'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Hunger Games 700x700.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 700; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    ...
    <img src='<?php echo $baseHref; ?>img/Photo President Snow 700x394.jpg' class="norm-image">
    <p class='par' id='tx_20'></p>
    <p class='par' id='tx_21'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Wizard of Oz 700x980.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 980; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    <p class='par' id='tx_22'></p>
    <span class='title3' id='tx_23'></span>
    <p class='par' id='tx_24'></p>
    <p class='par' id='tx_25'></p>
    <p class='par' id='tx_26'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Storm1 700x501.jpg' class="norm-image">
    <p class='par' id='tx_27'></p>
    <p class='par' id='tx_28'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Storm2 553x750.jpg' style='width: clamp(277px, 96.01vw, 553px); aspect-ratio: 553 / 750; height: auto !important; display: block; margin: auto; object-fit: contain;' /><br>
    <p class='par' id='tx_29'></p>
    <p class='par' id='tx_30'></p>
    <p class='par' id='tx_31'></p>
    <span class='title3' id='tx_32'></span>
    <img src='<?php echo $baseHref; ?>img/Photo Exodus 700x700.jpg' class="norm-image"><br>
    <p class='par' id='tx_33'></p>
    <p class='par' id='tx_34'></p>
    <p class='par' id='tx_35'></p>
    <p class='par' id='tx_36'></p>
    <span class='title3' id='tx_37'></span>
    <p class='par_italic' id='tx_38'><a href='https://www.amazon.co.uk/Storm-Last-Fighter-Bk-1/dp/0907610773' class='link' target='_blank' id='tx_73'></a></p>
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article09.json');
