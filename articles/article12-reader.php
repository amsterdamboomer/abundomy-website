<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article12.json";
    
    // FIXED: Set to exactly match your education page index definition for line 12
    $fallbackTitle = "Revive science"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 12
    $pageKeywords = "Revive Science, Scientific Freedom, Open Source Research, Academic Integrity, Scientific Reform, Unbiased Knowledge";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article12">
    ...
    <!-- ========================================= -->
    <img src='<?php echo $baseHref; ?>img/Photo Frankenstein 700x518.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 518; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    ...
    <img src='<?php echo $baseHref; ?>img/Photo George Carlin 700x404.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 404; height: auto !important; display: block; margin: auto; object-fit: contain;' /><br>
    <blockquote class="blockquote blockquote--bordered">
      <p class="blockquote__text" id='tx_17'></p>
      <p class="blockquote__text blockquote__text--credit" id='tx_18'></p>
    </blockquote><br>
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Platos Cave 700x782.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 782; height: auto !important; display: block; margin: auto; object-fit: contain;' /><br>
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Burning Desk 700x396.jpg' class="norm-image"><br>
    <span class='title3' id='tx_34'></span>
    <p class='par_italic'><a href='https://www.tue.nl/en/news-and-events/features/soccer-robots' class='link' target='_blank' id='tx_35'></a></p>
    <blockquote class="blockquote blockquote--bordered">
      <p class="blockquote__text" id='tx_36'></p>
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article12.json');
