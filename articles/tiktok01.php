...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    <br>
    <span class='title1' id='tx_01'>Banks Versus One Coin Per Hour</span>
    <span class='title4' id='tx_02'>How fast banks extract wealth from society.</span>
    ...
    <!-- ========================================= -->
    <!-- Fully Functional Fail-Safe Video Block -->
    <div class="short-video-wrapper" style="position: relative; background: #000; overflow: hidden; border-radius: 12px; border: 2px solid var(--text, #916B01); box-shadow: 0 8px 24px rgba(0,0,0,0.5);">
        ...
        <img src="<?php echo $baseHref; ?>img/Thumbnail Banks vs One Coin Per Hour 540x960.jpg" alt="Video Preview" />
        ...
        <div style="position: absolute; inset: 0; display: flex; flex-direction: column; align-items: center; justify-content: center; padding: 20px; text-align: center; gap: 15px; background: rgba(0, 0, 0, 0.35);">
            ...
            <!-- Centered Interactive Play Button Element Redirecting to TikTok App Engine -->
            <a href="https://www.tiktok.com/@abundomy/video/7620763291714964752" 
               target="_blank" 
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            // Target the safe local copy of your dictionary mapping layout profile
            const response = await fetch('<?php echo $baseHref; ?>json/tiktok01.json');
