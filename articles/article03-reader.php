<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article03.json";
    $fallbackTitle = "Why Our Current Money Doesn't Work"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 03
    $pageKeywords = "Money System Failure, Currency Flaws, Broken Economy, Inflation Causes, Central Bank Issues";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article03">
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Silvio Gesell 320x405.jpg' style='width: clamp(160px, 55.56vw, 320px); aspect-ratio: 320 / 405; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Money 700x347.jpg' class="norm-image"><br>
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Gold 700x436.jpg' class="norm-image"><br>
    <span class='title3' id='tx_28'></span>
    <p class='par' id='tx_29'></p>
    <p class='par' id='tx_30'></p>
    <p class='par' id='tx_31'></p>
    <p class='par' id='tx_32'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Corn 700x551.jpg' class="norm-image"><br>
    <p class='par' id='tx_33'></p>
    <p class='par' id='tx_34'></p>
    <p class='par' id='tx_35'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Glassmaker 700x701.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 701; height: auto !important; display: block; margin: auto; object-fit: contain;' /><br>
    ...
    <ul>
      <li><a id="tx_43" href="https://silviogesell.com/about/" class='link' target="_blank"></a></li>
      <li><a id="tx_44" href="https://www.youtube.com/watch?v=3J0i5VitQWo" class='link' target="_blank"></a></li>
      <li><a id="tx_45" href="https://silviogesell.com" class='link' target="_blank"></a></li>
    </ul>
    <blockquote class="blockquote blockquote--bordered">
      <p class="blockquote__text" id='tx_46'></p>
      <p class="blockquote__text" id='tx_47'></p>
      <p class="blockquote__text" id='tx_48'></p>
    </blockquote>
    <!-- ========================================= -->
    <br>
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article03.json');
