<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article28.json";
    
    // FIXED: Set to exactly match your education page index definition for line 28
    $fallbackTitle = "Will The War With Iran Wake Up People?"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 28
    $pageKeywords = "War With Iran, Geopolitics, Global Awareness, Monetary Context, Political Crisis, System Realization";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article28">
    ...
    <img src='<?php echo $baseHref; ?>img/Photo B2 Bomber 700x700.jpg' class="norm-image"><br>
    <p class='par' id='tx_05'></p>
    <p class='par' id='tx_06'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Puppet Medals 700x394.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 394; height: auto !important; display: block; margin: auto; object-fit: contain;' />
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article28.json');
