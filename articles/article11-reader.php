<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article11.json";
    
    // FIXED: Set to exactly match your education page index definition for line 11
    $fallbackTitle = "Money Islands"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 11
    $pageKeywords = "Money Islands, Isolationist Finance, Offshore Capital, Localized Currencies, Monetary Enclaves";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article11">
    ...
    <!-- ========================================= -->
     <img src='<?php echo $baseHref; ?>img/Photo Money Islands 700x335.jpg' class="norm-image"><br>
    ...
    <p class='par' id='tx_19'></p>
     <img src='<?php echo $baseHref; ?>img/Photo Raspberry Pi 700x467.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 467; height: auto !important; display: block; margin: auto; object-fit: contain;' />
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article11.json');
