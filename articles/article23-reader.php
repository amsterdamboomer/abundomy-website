<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article23.json";
    
    // FIXED: Set to exactly match your education page index definition for line 23
    $fallbackTitle = "Jail A Monopoly"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 23
    $pageKeywords = "Jail A Monopoly, Corporate Monopoly, Market Control, Antitrust, Banking Cartel, Legal Accountability";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article23">
   ...
   <img src='<?php echo $baseHref; ?>img/Photo Fence 700x477.jpg' class="norm-image"><br>
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Statism 700x467.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 467; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    <p class='par_italic' id='tx_22' style='text-align: center; width: 100%; display: block;'></p>
    ...
    <img src='<?php echo $baseHref; ?>img/Photo No Trespassing 700x525.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 525; height: auto !important; display: block; margin: auto; object-fit: contain;' />
    <p class='par_italic' id='tx_34' style='text-align: center; width: 100%; display: block;'></p>
    <p class='par' id='tx_35'></p>
    <span class='title3' id='tx_36'></span>
    <p class='par' id='tx_37'></p>
    <p class='par' id='tx_38'></p>
    <p class='par' id='tx_39'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Real Market 700x466.jpg' class="norm-image">>
    <span class='title3' id='tx_40'></span>
    <p class='par' id='tx_41'></p>
    <p class='par' id='tx_42'></p>
    <span class='title3' id='tx_43'></span>
    <ul>
      <li><a href='https://www.abundomy.com/articles/article01-reader.php' class='link' id='tx_45'></a></li>
      <li><a href='https://silviogesell.com/' class='link' target='_blank' id='tx_46'></a></li>
      <li><a href='https://en.wikipedia.org/wiki/Henry_George' class='link' target='_blank' id='tx_47'></a></li>
      <li><a href='https://en.wikipedia.org/wiki/Statism' class='link' id='tx_48'></a></li>
      <li><a href='https://www.unoosa.org/oosa/en/ourwork/spacelaw/treaties/outerspacetreaty.html' class='link' target='_blank' id='tx_49'></a></li>
      <li><a href='https://www.abundomy.com/articles/article24-reader.php' class='link' id='tx_50'></a></li>
    </ul>
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article23.json');
