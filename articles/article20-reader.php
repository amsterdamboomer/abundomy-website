<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article20.json";
    
    // FIXED: Set to exactly match your education page index definition for line 20
    $fallbackTitle = "Universal Declaration of Human Rights"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 20
    $pageKeywords = "Universal Declaration of Human Rights, Human Rights, International Law, Social Justice, Global Rights, Legal Framework";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article20">
    ...
    <p class='par_italic' id='tx_11'></p>
    <span class='par_bold' id='tx_12'></span>
    <p class='par' id='tx_13'></p><br>

    <span class='title3' id='tx_14'></span>
    <p class='par' id='tx_15'></p><br>

    <span class='title3' id='tx_16'></span>
    <p class='par' id='tx_17'></p><br>

    <span class='title3' id='tx_18'></span>
    <p class='par' id='tx_19'></p><br>

    <span class='title3' id='tx_20'></span>
    <p class='par' id='tx_21'></p><br>

    <span class='title3' id='tx_22'></span>
    <p class='par' id='tx_23'></p><br>
    <span class='title3' id='tx_24'></span>
    <p class='par' id='tx_25'></p><br>

    <span class='title3' id='tx_26'></span>
    <p class='par' id='tx_27'></p><br>

    <span class='title3' id='tx_28'></span>
    <ol>
        <li><p class='par' id='tx_29'></p></li>
        <li><p class='par' id='tx_30'></p></li>
    </ol><br>
    ...
    <ol>
        <li><p class='par' id='tx_40'></p></li>
        <li><p class='par' id='tx_41'></p></li>
        <li><p class='par' id='tx_42'></p></li>
    </ol><br>

    <span class='title3' id='tx_43'></span>
    <p class='par' id='tx_44'></p><br>

    <span class='title3' id='tx_45'></span>
    <p class='par' id='tx_46'></p><br>
    ...
    <ol>
        <li><p class='par' id='tx_51'></p></li>
        <li><p class='par' id='tx_52'></p></li>
        <li><p class='par' id='tx_53'></p></li>
    </ol><br>

    <span class='title3' id='tx_54'></span>
    <p class='par' id='tx_55'></p><br>

    <span class='title3' id='tx_56'></span>
    <ol>
        <li><p class='par' id='tx_57'></p></li>
        <li><p class='par' id='tx_58'></p></li>
    </ol><br>

    <span class='title3' id='tx_59'></span>
    <ol>
        <li><p class='par' id='tx_60'></p></li>
        <li><p class='par' id='tx_61'></p></li>
    </ol><br>

    <span class='title3' id='tx_62'></span>
    <ol>
        <li><p class='par' id='tx_63'></p></li>
        <li><p class='par' id='tx_64'></p></li>
    </ol><br>
    ...
    <span class='title3' id='tx_68'></span>
    <p class='par' id='tx_69'></p><br>

    <span class='title3' id='tx_70'></span>
    <p><a href='https://www.abundomy.com/articles/article19-reader.php' target='_blank'><button class='login-button' id='tx_71'></button></a></p>


    <blockquote class="blockquote blockquote--bordered">
      <p class="blockquote__text" id='tx_72'></p>
      <p class="blockquote__text" id='tx_73'></p>
      <p class="blockquote__text" id='tx_74'></p>
    </blockquote>    <!-- ========================================= -->
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article20.json');
