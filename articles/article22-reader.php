<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article22.json";
    
    // FIXED: Set to exactly match your education page index definition for line 22
    $fallbackTitle = "Vote Harder!"; 
    ...
    // Explicit dynamic key-phrases matching the specific content of Article 22
    $pageKeywords = "Vote Harder, Illusion of Choice, Political System, Electoral Illusion, Democratic Fallacy, Systemic Limitation";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <div class="article-header-row">
        ...
        <div class="pdf-wrap">
            <form action="../includes/generate-pdf-r.inc.php" method="POST" target="_blank" style="display:inline;">
                <input type="hidden" name="article_id" value="article22">
    ...
    <img src='<?php echo $baseHref; ?>img/Photo Meatball 700x804.jpg' class="norm-image">
    <span class='title3' id='tx_08'></span>
    <p class='par' id='tx_09'></p>
    <p class='par' id='tx_10'></p>
    <p class='par' id='tx_11'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Voting 700x474.jpg' style='width: clamp(350px, 121.53vw, 700px); aspect-ratio: 700 / 474; height: auto !important; display: block; margin: auto; object-fit: contain;' />
...
<script>
    ...
    async function loadArticle() {
        ...
        try {
            ...
            const response = await fetch('<?php echo $baseHref; ?>json/article22.json');
