<?php 
    ...
    $jsonPath = $projectRoot . "/../json/article05.json";
    
    // FIXED: Set to exactly match your education page index definition for line 5
    $fallbackTitle = "The 2 Monopolies of Central Banks"; 
    ...
    $pageKeywords = "Central Bank Monopolies, Currency Control, Financial Hegemony, Monetary Monopoly, Banking Systems";
...
<div id="capture-section" class="selectable-text <?php echo $isRTL ? 'rtl-mode' : ''; ?>" <?php echo $isRTL ? 'dir="rtl"' : 'dir="ltr"'; ?>>
    ...
    <!-- ========================================= -->
    <img src='<?php echo $baseHref; ?>img/Photo FED 700x459.jpg' class="norm-image"><br>
    <p class='par' id='tx_04'></p>
    <span class='title3' id='tx_05'></span>
    <p class='par' id='tx_06'></p>
    <img src='<?php echo $baseHref; ?>img/Photo Printing Money 700x272.jpg' class="norm-image"><br>
    ...
    <ul>
      <li><a href='https://www.investopedia.com/terms/i/invisiblehand.asp' class='link' target='_blank' id='tx_27'></a></li>
      <li><a href='https://era.org.au/is-the-u-s-federal-reserve-privately-owned/' class='link' target='_blank' id='tx_28'></a></li>
      <li><a href='https://www.investopedia.com/powell-sees-audit-the-fed-push-as-threat-to-central-bank-s-existence-11678911' class='link' target='_blank' id='tx_29'></a></li>
      <li><a href='https://www.investopedia.com/what-to-expect-from-fed-chair-powell-s-testimony-to-congress-this-week-8789476' class='link' target='_blank' id='tx_30'></a></li>
      <li><a href='https://www.goodreads.com/book/show/66499.The_Creature_from_Jekyll_Island' class='link' target='_blank' id='tx_31'></a></li>
      <li><a href='https://youtu.be/AOk3wBuQNcE?si=PFSgd4lXa1gVhfBO' class='link' target='_blank' id='tx_32'></a></li>
    </ul>
    <blockquote class="blockquote blockquote--bordered">
